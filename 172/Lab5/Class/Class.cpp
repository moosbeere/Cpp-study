...
int main()
{
    setlocale(LC_ALL, "");
    //Lab5 Task 3
    //Monster m1; ошибка создания объекта от абстрактного класса
    FlyMonster fly;
    fly.print();
    FlyMonster f("Dragon", 20, 5, 30, 10);
    fly.attack(f);
    f.print();
    CrawlingMonster mn;
    mn.print();
   ...
   // mn.print();
    ...
    FlyMonster fly2("Dragon2", 13, 3, 22,30 );
    fly2.fly();
    Monster m1;
    m1.print();
    fly2.print();

    Monster m2 = FlyMonster();
    //FlyMonster f1 = Monster("Spider");
